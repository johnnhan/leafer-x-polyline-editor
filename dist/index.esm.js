import { ArrowData, Arrow, arrowType } from '@leafer-in/arrow';
import { dataProcessor, boundsType, createAttr, registerUI, strokeType, dataType, GroupData, Group, PointerEvent, ZoomEvent, MoveEvent, DragEvent, Line, Ellipse } from '@leafer-ui/core';
...
let PolylineData$1 = class PolylineData extends ArrowData {
};
...
], FreePolyline.prototype, "editConfig", void 0);
FreePolyline = __decorate([
    registerUI()
], FreePolyline);

class PolylineData extends ArrowData {
...
], OrthoPolyline.prototype, "editConfig", void 0);
OrthoPolyline = __decorate([
    registerUI()
], OrthoPolyline);

class PolylineEditorData extends GroupData {
}
...
class PolylineEditor extends Group {
    constructor(config) {
        super(config);
        this.line = null;
