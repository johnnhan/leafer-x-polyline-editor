...
class FreePolylineData extends arrow.ArrowData {
}
...
class FreePolylineEditor extends core.Group {
    ...
    initEvents() {
        this.waitLeafer(() => {
            ...
            if (isApp && zoomLayer && zoomLayer == this.parent) {
                ...
                this.app.on(core.ZoomEvent.ZOOM, this.zoomHandler.bind(this));
            }
            else {
    ...
    clearEditor() {
        this.edgeEllipses.forEach(ellipse => {
            ellipse.off(core.PointerEvent.DOWN);
        });
        this.midEllipses.forEach(ellipse => {
            ellipse.off(core.PointerEvent.DOWN);
        });
        this.rect.off(core.PointerEvent.DOWN);
        this.line = null;
        this.rect = null;
        this.edgeEllipses = [];
        this.midEllipses = [];
    ...
    addRectEvents(rect) {
        rect.on(core.PointerEvent.DOWN, (e) => {
            const { x: originX, y: originY } = this.selectItem;
            const { x: startX, y: startY } = e.getPagePoint();
            const appMoveEventId = this.app.on_(core.PointerEvent.MOVE, (e) => {
            ...
            rect.on(core.PointerEvent.UP, () => {
                this.app.off_(appMoveEventId);
                rect.off(core.PointerEvent.UP);
            });
        });
    }
    addEdgeEvents(ellipse, index) {
        ellipse.on(core.PointerEvent.DOWN, (e) => {
            ...
            ellipse.on(core.PointerEvent.UP, () => {
                this.app.off_(appMoveEventId);
                ellipse.off(core.PointerEvent.UP);
                ellipse.off(core.PointerEvent.DOWN);
                this.redrawEllipses();
...
__decorate([
    core.sortType(EDITOR_DEFAULT_Z_INDEX)
], FreePolylineEditor.prototype, "zIndex", void 0);

class OrthoPolylineEditor extends core.Group {
    constructor(config = {}) {
        const { color, strokeWidth, ellipseWidth, } = config;
        super();
        this.color = color !== null && color !== void 0 ? color : EDITOR_DEFAULT_COLOR;
...
exports.FreePolylineEditor = FreePolylineEditor;
exports.OrthoPolylineEditor = OrthoPolylineEditor;
